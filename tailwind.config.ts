  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        surface: { DEFAULT: "hsl(var(--surface))", hover: "hsl(var(--surface-hover))", elevated: "hsl(var(--surface-elevated))" },
      ...
      keyframes: {
        ...
        "like-pop": { "0%": { transform: "scale(1)" }, "50%": { transform: "scale(1.4)" }, "100%": { transform: "scale(1)" } },
      },
      animation: {
